...
meta:
	ADDON_NAME = ofx3jGpuLutCube
	ADDON_DESCRIPTION = load .cube luts via GPU
	ADDON_AUTHOR = @johanjohan
	ADDON_TAGS = "addon" "lut" "cube" "gpu"
	ADDON_URL = https://github.com/johanjohan/ofx3jGpuLutCube
